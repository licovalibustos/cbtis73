...
- **THEN** el sistema busca o crea la plantilla, registra la materia con `plantilla_id` y la especialidad correspondiente; solo es visible en grupos de esa especialidad
